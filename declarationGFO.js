export default function declarationGFO (company, eik, egn, manager) {
    ...
    Представеният за обявяване годишен финансов отчет и годишен доклад за дейността за 2019 г. е приет от ${organ} или от съответния орган по чл. 38, ал. 1 от Закона за счетоводството.
